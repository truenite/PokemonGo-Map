...
function initMap() {
  ...
  function scannedLabel(last_modified,search_id) {
    ...
    <br> SearchLocationId = ${pad(search_id)}
    </div>`;
    return contentstring;
  };
  ...
  function getGoogleSprite(index, sprite, display_height) {
    ...
    function setupScannedMarker(item) {
      ...
      marker.infoWindow = new google.maps.InfoWindow({
        content: scannedLabel(item.last_modified,item.search_id),
