...
class Pogom(Flask):
    def __init__(self, import_name, **kwargs):
        ...
        self.route('/zonasEscaneadas', methods=['GET'])(self.fullmap_with_scan)
        self.route("/raw_data_with_scan", methods=['GET'])(self.raw_data_with_scan)
